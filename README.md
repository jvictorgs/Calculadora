...
<p align="center">A Calculadora foi desenvolvida para meu auxílio em atividades da faculdade e também para consolidar meus aprendizados na faculdade no primeiro período, seu funcionamento funciona da seguinte forma: Ela processa qualquer valor e consegue fazer todas as operações, sendo possível excluir todos os dados inseridos, ou excluir apenas o da linha que está sendo escrito o número. Esse projeto foi inspirado em outro, mas seu desenvolvimento foi totalmente individual.</p>
